# alphaMind AI Trade Decision Prompt v1
...
7. Keep rationale concise and factual. Natural-language rationale is for human review only and
   must not be used by execution code to derive parameters.
